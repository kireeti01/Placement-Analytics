...
print('=' * 60)
print('STUDENT IMPORT SCRIPT (FIXED)')
print('=' * 60)
...
for i in range(1, 201):
    ...
    if status == 'placed':
        ...
        company = ''  # Changed from None to empty string
        package = None
    ...
    student = {
        ...
        'phone': phone,
        'branch': branch,
        # 'batch': '2024',  # REMOVED - not in model
        'cgpa': cgpa,
        ...
        'company': company,  # Now empty string instead of None
